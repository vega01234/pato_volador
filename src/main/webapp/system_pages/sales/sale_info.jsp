        ...
        <main class="content_page">
            ...
            <div class="div_form">
                <div class="header_forms">
                    <h1 class="title_page center_text">Informacion de la Venta</h1>
                    <%
                        if (sale == null) {
                    %>
                    <p class="center_text"><b>ERROR: </b>No se encontró información del la venta.</p>
                    <%
                        } else {
                    %>
                    <p>Datos de la Venta con ID: <b><%= sale.getId_sale() %></b>.</p>
                </div>
                <p><b>Venta No.: </b><%=  %>.</p>
                <p><b>ID del Usuario: </b><%=  %>.</p>
                <p><b>ID del Usuario: </b><%=  %>.</p>
                <p><b>ID del Usuario: </b><%=  %>.</p>
                <p><b>ID del Usuario: </b><%=  %>.</p>
                <p><b>ID del Usuario: </b><%=  %>.</p>
