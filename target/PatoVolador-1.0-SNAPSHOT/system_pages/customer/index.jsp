...
<html>
    ...
    <body>
        ...
        <header class="navbar">
            ...
            <nav>
                <ul class="nav_list">
                    ...
                    <li><a href="./index.jsp" class="link_ref">Clientes</a></li>
        ...
        <main class="content_page">
            <h2 class="subtitle_page center_text">Clientes - El Pato Volador</h2>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                renderLinkCards(customerCards, "card_container");
            })
        </script>
    </body>
</html>
